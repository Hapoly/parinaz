...
if($count > 10){
  ...
  echo '
    <div class="row" style="text-align: center" >
      <ul class="pagination">
        <li class="'. ($page==0? 'disabled': '') .'"><a href="?page=0"><i class="fa fa-angle-double-left" aria-hidden="true"></i></a></li>
        <li class="'. ($page==0? 'disabled': '') .'"><a href="?page='. ($page-1) .'"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li>
        <li><a href="">'. ($page+1) .'/'. $page_count .'</a></li>
        <li class="'. ($page==$page_count-1? 'disabled': '') .'"><a href="?page='. ($page+1) .'"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
        <li class="'. ($page==$page_count-1? 'disabled': '') .'"><a href="?page='. ($page_count-1) .'"><i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
      </ul>
    </div>
  ';
}
